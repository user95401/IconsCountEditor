...
void updateIconsCount() {
    ...
    ModUtils::write_bytes((base + 0x1E6DEF), { 0xB8, ship, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x1F7FF6), { 0xBa, ship, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x12C6D1), { 0xc7, 0x44, 0x24, 0x14, ship, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x12B0CA), { 0xc7, 0x44, 0x24, 0x1c, ship, 0x00, 0x00, 0x00});

    // balls = 15 = 0F;                                                                             ship balls = 42 = 2a;
    ModUtils::write_bytes((base + 0x12C6EC), { 0xc7, 0x44, 0x24, 0x14, ball, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x12B0FF), { 0xc7, 0x44, 0x24, 0x1c, ball, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x1F83A6), { 0xba, ball, 0x00, 0x00, 0x00});

    // ufo = 14 = 0E;                                                                             ufo default = 35 = 23; 
    ModUtils::write_bytes((base + 0x22DA45), { 0xB9, ufo, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x24A18F), { 0xB8, ufo, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x24B210), { 0xB8, ufo, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x1F81A6), { 0xBA, ufo, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x12B134), { 0xc7, 0x44, 0x24, 0x1c, ufo, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x12C704), { 0xc7, 0x44, 0x24, 0x14, ufo, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x25612A), { 0xc7, 0x84, 0x24, 0x28, 0x0a, 0x00, 0x00, ufo, 0x00, 0x00, 0x00});

    // wave = 13 = 0D;                                                                             wave default = 35 = 23; 
    ModUtils::write_bytes((base + 0x128568), { 0xb8, wave, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x142762), { 0xbb, wave, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x1F8586), { 0xba, wave, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x12B169), { 0xc7, 0x44, 0x24, 0x1c, wave, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x12C71C), { 0xc7, 0x44, 0x24, 0x1c, wave, 0x00, 0x00, 0x00});
    ...
    //(crash - no access thing idk)ModUtils::write_bytes((base + 0x199436), { 0xC7, 0x84, 0x24, 0x08, 0x2E, 0x44, 0x00, robot, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x1F855A), { 0xba, robot, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x20CCD5), { 0xb9, robot, 0x00, 0x00, 0x00});
    ModUtils::write_bytes((base + 0x14673D), { 0xb8, robot, 0x00, 0x00, 0x00});
